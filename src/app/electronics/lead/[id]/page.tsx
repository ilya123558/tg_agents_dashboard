...
export default function LeadDetailPage() {
  ...
  function goBack() {
    // Если есть история на этом сайте — назад (восстановит URL с query params и скролл).
    // Иначе fallback на push /electronics.
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] pb-10">
      ...
      <div className="sticky top-0 z-10 bg-[#0f0f0f]/90 backdrop-blur-sm border-b border-white/5
        ...
        <span className="text-sm font-medium text-white truncate flex-1">🛒 Лид · @{un}</span>
        <Link
          href={`/electronics/messages?chat=${lead.id}`}
